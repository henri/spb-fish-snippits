...
# one line command to configure spb-google-ai functioin to start multiple google ai searches in multiple private browser tabs.
        ...
        while test (count $argv) -gt 0
            switch $argv[1]
                ...
                case  '--standard' '--quite' '--quiet' '--verbose' '--about'
                    echo "$argv[1]"
                case '*'
                    echo (echo "https://www.google.com/search?q=$argv[1]&udm=50" | tr " " "+")
...
funcsave spb-google-ai



# usage example - lets say you want to start five chats in five tabs. Use the command below : 
# spb-google-ai "cats creap" "dogs dance" "mice play" "dear dash" "rabbits rule"

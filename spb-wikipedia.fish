# one line command to configure spb-wikipedia functioin to start multiple Wikipedia searches in multiple private browser tabs.
...
funcsave spb-wikipedia



# usage example - lets say you want to start five searches in five tabs. Use the command below : 
# spb-wikipedia "cats creap" "dogs dance" "mice play" "dear dash" "rabbits rule"

# one line command to configure spb-rotten-tomatoes function to start multiple Rotten Tomatoes searches in multiple private browser tabs.
...
function spb-rotten-tomatoes
    ...
    set urls ( 
        ...
        if test $url_count -eq 0
            echo "https://www.rottentomatoes.com/"
        end
    )
   spb $urls
end 
funcsave spb-rotten-tomatoes



# usage example - lets say you want to start five searches in five tabs. Use the command below : 
# spb-rotten-tomatoes "keanu" "matrix" "blade runner" "back to the future" "zootopia"

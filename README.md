...
Initating web searches and conversations from the shell will be [easy-as](https://github.com/henri/spb/blob/main/FAQ.md#what-is-easy-as) with these fish nippits configured on your system! Get moving [fast-as](https://github.com/henri/spb/blob/main/FAQ.md#what-is-easy-as) in the worlds digital currents.

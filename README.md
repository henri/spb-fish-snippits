...
Initating web searches and conversations from the fish shell will be [easy-as](https://github.com/henri/spb/blob/main/FAQ.md#what-is-easy-as) with these snippits loaded on your system! [Get moving](https://github.com/henri/spb/blob/main/README.md#fish-shell-wrappers) in the worlds digital currents.
